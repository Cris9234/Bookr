# Generated by Django 3.2.5 on 2022-03-20 22:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(help_text="The contributor's first last name or names", max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_editing', models.DateField(help_text='The date and time the review was last edited.', null=True)),
                ('book', models.ForeignKey(help_text='The book that this review in for.', on_delete=django.db.models.deletion.CASCADE, to='reviews.book')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('AUTHOR', 'Author'), ('CO_AUTHOR', 'Co-Author'), ('EDITOR', 'Editor')], max_length=20, verbose_name='The role this contributor had in te book')),
